...
namespace Domain.WorkTimeAggregate.Events
{
    public class Event
    {
        ...
        public long AggregateId { get; internal set; }
        ...
        public Event(long aggregateId, DateTime date, EventName eventName)
        {
    ...
    {
        public static void Deserialize(long? id, long aggregateId, long aggregateVersion, DateTime date,
